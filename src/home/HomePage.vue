      ...
      <div class="alert alert-info">
        ...
        <div class="input-group mb-3">
          ...
          <div class="input-group-append">
            <button class="btn btn-outline-secondary" type="button" @click="findByPlate()">Start</button>
            <button class="btn btn-outline-secondary" type="button" @click="restart()">Restart</button>
          </div>
        </div>
        <div class="form-group" v-if="!found">
          <div class="form-row align-items-center">
            <div class="col-auto my-1">
              ...
              <select v-model="checkInOut.spaceId" class="custom-select mr-sm-2" :required="true">
        ...
        <div class="form-group" v-if="!checkInOut.status">
          ...
          <button class="btn btn-primary" :disabled="loading" @click="checkOut()" v-if="isCheckedIn">
            <span class="spinner-border spinner-border-sm" v-show="loading"></span>
            <span>Check out</span>
          </button>
          <button class="btn btn-primary" :disabled="loading" @click="registerPayment()" v-if="isCheckedOut && !checkInOut.status">
            <span class="spinner-border spinner-border-sm" v-show="loading"></span>
            <span>Pay</span>
          </button>
        </div>
